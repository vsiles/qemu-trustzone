...
#define VMSTATE_BANKED_UINT32(_f, _s) \
    VMSTATE_UINT32(_f.secure, _s), \
    VMSTATE_UINT32(_f.normal, _s)
const VMStateDescription vmstate_arm_cpu = {
    ...
    .fields = (VMStateField[]) {
        ...
        VMSTATE_BANKED_UINT32(env.cp15.c1_sys, ARMCPU),
        ...
        VMSTATE_BANKED_UINT32(env.cp15.c2_base0, ARMCPU),
        VMSTATE_BANKED_UINT32(env.cp15.c2_base0_hi, ARMCPU),
        VMSTATE_BANKED_UINT32(env.cp15.c2_base1, ARMCPU),
        VMSTATE_BANKED_UINT32(env.cp15.c2_base1_hi, ARMCPU),
        VMSTATE_BANKED_UINT32(env.cp15.c2_control, ARMCPU),
        VMSTATE_BANKED_UINT32(env.cp15.c2_mask, ARMCPU),
        VMSTATE_BANKED_UINT32(env.cp15.c2_base_mask, ARMCPU),
        VMSTATE_BANKED_UINT32(env.cp15.c2_data, ARMCPU),
        VMSTATE_BANKED_UINT32(env.cp15.c2_insn, ARMCPU),
        VMSTATE_BANKED_UINT32(env.cp15.c3, ARMCPU),
        VMSTATE_BANKED_UINT32(env.cp15.c5_insn, ARMCPU),
        VMSTATE_BANKED_UINT32(env.cp15.c5_data, ARMCPU),
        VMSTATE_UINT32_ARRAY(env.cp15.c6_region, ARMCPU, 8),
        VMSTATE_BANKED_UINT32(env.cp15.c6_insn, ARMCPU),
        VMSTATE_BANKED_UINT32(env.cp15.c6_data, ARMCPU),
        VMSTATE_BANKED_UINT32(env.cp15.c7_par, ARMCPU),
        VMSTATE_BANKED_UINT32(env.cp15.c7_par_hi, ARMCPU),
        ...
        VMSTATE_BANKED_UINT32(env.cp15.c13_fcse, ARMCPU),
        VMSTATE_BANKED_UINT32(env.cp15.c13_context, ARMCPU),
        VMSTATE_BANKED_UINT32(env.cp15.c13_tls1, ARMCPU),
        VMSTATE_BANKED_UINT32(env.cp15.c13_tls2, ARMCPU),
        VMSTATE_BANKED_UINT32(env.cp15.c13_tls3, ARMCPU),
