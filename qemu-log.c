...
const CPULogItem cpu_log_items[] = {
    ...
    { CPU_LOG_CP_SECURE, "coproc",
      "arm only: show all cp reads/writes by secure world" },
    { CPU_LOG_CP_NORMAL, "coproc_ns",
      "arm only: show all cp reads/writes by normal world" },
    { CPU_LOG_CP_GDB, "coproc_gdb",
      "arm only: show all cp reads/writes by gdb" },
    { LOG_UNIMP, "unimp",
